...
I also implemented the save funcionality so it automatically saves my data and prevents my previously written files from deleting just becaue i exited my system.
